...
if __name__ == "__main__":
    ...
    nasNet = nasnet.NASNetLarge(weights='imagenet', include_top=False,input_shape=(331, 331, 3))
    ...
    for i,file_name in enumerate(data_names):
        ...
        inception_resnet_v2_feature_arr = nasnet_feature_extractor(preprocess_image)
