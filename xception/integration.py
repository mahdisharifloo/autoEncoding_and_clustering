...
if __name__ == "__main__":
    # import xception model for extracrating image features.
    ...
    #/home/mahdi/projects/dgkala/cluster_xception/data/ring_glasses_hand_watch/
    ...
    for i,file_name in enumerate(data_names):
        ...
        xception_feature_arr = xception_feature_extractor(preprocess_image)
        cluster_pred = kmeans.predict(xception_feature_arr)
