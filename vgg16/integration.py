...
def vgg16_feature_extractor(preprocess_image):
    # preprocessing for image input the vgg_server
    # preprocess_image = nn_image_preprocessing(image_bytes)
    processed_imgs = vgg16.preprocess_input(preprocess_image)
...
if __name__ == "__main__":
    # import vgg16 model for extracrating image features.
    ...
    #/home/mahdi/projects/dgkala/cluster_vgg16/data/ring_glasses_hand_watch/
    ...
    for i,file_name in enumerate(data_names):
        ...
        vgg16_feature_arr = vgg16_feature_extractor(preprocess_image)
        cluster_pred = kmeans.predict(vgg16_feature_arr)
