...
def vgg19_feature_extractor(preprocess_image):
    # preprocessing for image input the vgg_server
    # preprocess_image = nn_image_preprocessing(image_bytes)
    processed_imgs = vgg19.preprocess_input(preprocess_image)
...
if __name__ == "__main__":
    # import vgg19 model for extracrating image features.
    ...
    #/home/mahdi/projects/dgkala/cluster_vgg19/data/ring_glasses_hand_watch/
    ...
    for i,file_name in enumerate(data_names):
        ...
        vgg19_feature_arr = vgg19_feature_extractor(preprocess_image)
        cluster_pred = kmeans.predict(vgg19_feature_arr)
