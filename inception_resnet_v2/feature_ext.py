...
def feature_table_creator(image_bytes):
    ...
    feature_table = {'inception_resnet_v2':None}
    # feature_table['vgg'] = vgg(image_bytes)
    feature_table['inception_resnet_v2'] = InceptionResNetV2(image_bytes)
...
if __name__ == "__main__":
    ...
    for i,img_path in enumerate(pics_num):
        ...
        features['inception_resnet_v2'].append(single_feature_table['inception_resnet_v2'])
        bar.update(i+1)
        sleep(0.1)
