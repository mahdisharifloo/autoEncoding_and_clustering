...
global inception_resnet_v2_extractor
...
def inception_resnet_v2_feature_extractor(preprocess_image):
    ...
    inception_resnet_v2_features =inception_resnet_v2_extractor.predict(processed_imgs)
...
if __name__ == "__main__":
    # import inception_resnet_v2 model for extracrating image features.
    inception_resnet_v2_extractor = inception_resnet_v2.InceptionResNetV2(weights='imagenet', include_top=False,input_shape=(224, 224, 3))
    ...
    for i,file_name in enumerate(data_names):
        ...
        inception_resnet_v2_feature_arr = inception_resnet_v2_feature_extractor(preprocess_image)
        cluster_pred = kmeans.predict(inception_resnet_v2_feature_arr)
